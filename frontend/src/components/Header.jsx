...
import { disablePageScroll , enablePageScroll, enblePageScroll } from 'scroll-lock'
  ...
  return (
    ...
    lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8':'bg-n-8/90 backdrop-blur-sm'}`}>
        ...
        xl:px-10 max-lg:py-4">
            ...
            <Button className="hidden lg:flex" href="#login"><Link to="/Signin">Sign In</Link></Button>
